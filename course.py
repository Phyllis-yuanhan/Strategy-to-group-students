...
class Student:
    ...
    _answer: a dictionary whose keys are the id of the answers and
     corresponding values are the answers
    ...
    def has_answer(self, question: Question) -> bool:
        ...
        if question.id in self._answer and \
                self._answer[question.id].is_valid(question):
            return True
        else:
            return False
