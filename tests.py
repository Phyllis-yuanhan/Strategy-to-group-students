...
class TestMultipleChoiceQuestion:
    def test__str__(self) -> None:
        assert str(mcq1) == 'The question is Pick One with the following ' \
...
class TestNumericQuestion:
    def test__str__(self) -> None:
        assert str(nq1) == 'The question is Calculate 5 + 5 whose answers ' \
...
class TestYesNoQuestion:
    def test__str__(self) -> None:
        assert str(ynq1) == 'The question is Is the sky blue? whose answer ' \
...
class TestCheckboxQuestions:
    def test__str__(self) -> None:
        assert str(cq1) == 'The question is Which of the following are less ' \
                           'than 5? with the following possible choices 1,2,' \
                           '3,4,5'
...
class TestSurvey:
    ...
    def test__str__(self) -> None:
        assert str(survey1) == 'The question is Which of the following are ' \
                               'less than 5? with the following possible ' \
                               'choices 1,2,3,4,5\n'
